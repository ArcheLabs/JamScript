...
enum minijam_host_call {
  ...
  MINIJAM_HOST_OWNERSHIP_CONTROL_SERVICE_ID = 28,
...
#define JAM_HOST_NETWORK_DOMAIN MINIJAM_HOST_NETWORK_DOMAIN
#define JAM_HOST_OWNERSHIP_CONTROL_SERVICE_ID MINIJAM_HOST_OWNERSHIP_CONTROL_SERVICE_ID
